    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-background to-muted pt-16 md:pt-24 lg:pt-32">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center gap-4 text-center md:gap-10">
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:gap-12 mt-8">
              <div className="process-card group relative flex flex-col items-center rounded-xl border bg-card p-6 text-card-foreground shadow-sm transition-all hover:shadow-md">
      ...
      <section className="bg-muted py-16 md:py-24">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div className="calculator-card mt-8 w-full max-w-3xl rounded-xl border bg-card p-6 shadow-lg">
          ...
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
              {[
                ...
                <div
                  key={index}
                  className="testimonial-card flex flex-col rounded-xl border bg-card p-6 text-card-foreground shadow-sm"
                >
